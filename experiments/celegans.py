...
### Set the outputs
RESULTS_DIR = os.path.join("results", "celegans", "2017_05_15")
...
def run_experiments():
    ...
    for M, T, N, num_given_neurons, num_poss_per_neuron, rho, etasq in \
        ...
        sim = cached(RESULTS_DIR, experiment_name + "_data")(simulate_data)
        Ys, A, W_true, Ps_true, Cs = \
            sim(M, T, N, num_given_neurons, num_poss_per_neuron,
                etasq=etasq, rho=rho)
