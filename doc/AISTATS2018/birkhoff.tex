...
\aistatsauthor{ Scott W. Linderman$^*$ \And Gonzalo E. Mena$^*$
  \And  Hal Cooper}
...
\begin{figure*}[ht!]
  ...
  \caption{Reparameterizations of discrete polytopes.  From left to
    ...
    points~$\beta \in [0,1]^{N-1}$ to~$\Delta_N$, but
    ...
    doubly-stochastic matrices. We show how~$\mcB_3$ is
    reparameterized in terms of matrices~$\Psi \in [0,1]^{2 \times 2}$
