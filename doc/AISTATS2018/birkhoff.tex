...
\end{table}
 ...
 We found our method outperforms the simple Mallows distribution, suggesting it might reasonably approximate non-trivial distributions over permutations. Fig ~\ref{fig:synthetic} illustrates our findings by showing experiment configurations (a), examples of inferred posteriors (b) and histogram of BD's histograms (c). These histograms are complemented by Table \ref{table:BDs}.
...
\todo{this intro and sec 4.1 can be cut substantially}
