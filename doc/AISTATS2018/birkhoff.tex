...
turn and then discuss their relative merits. Also, in the supplement, we provide implementation details (how to compute equation\eqref{eq:elbo}) for both methods. 
...
to the supplement. There, we also provide further details about all experiments described hereafter.
