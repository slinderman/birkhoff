...
\todo[inline]{Short story: we can easily incorporate additional
  constraints (like $x_{mn}=0$) in the rounding approach.  The stick
  breaking approach is trickier: in essence, the upper and lower
  bounds produced above are one-dimensinoal projections of the
  constrained Birkhoff polytope.  Given additional constraints,
  these projections become trickier to derive.}
